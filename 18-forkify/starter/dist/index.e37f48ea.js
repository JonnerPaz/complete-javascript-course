...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}/${id.slice(1)}`);
...
const API_KEY = "6caa6664-9844-488d-bd83-01c7fbdb5e48";
...
class RecipeView {
    ...
    #generateHtml() {
        ...
        <div class="recipe__ingredients">
          ...
          ${this.#data.ingredients.map((ingredient)=>this.#generateHtmlIngredient(ingredient)).join("")}
          </ul>
        </div>
